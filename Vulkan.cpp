...
private:
    ...
    void createGraphicsPipeline() {
        auto vertShaderCode = readFile("C:/Users/kym10/source/repos/Vulkan/Vulkan/shaders/vert.spv");
        auto fragShaderCode = readFile("C:/Users/kym10/source/repos/Vulkan/Vulkan/shaders/frag.spv");
    ...
    void drawFrame() {
        vkWaitForFences(device, 1, &inFlightFence[currentFrame], VK_TRUE, UINT64_MAX); //e
